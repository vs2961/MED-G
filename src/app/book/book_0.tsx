...
export function Book_1({ setPage, setPatient }: BookProps) {
  const router = useRouter();
  return (
    <Navigation>
      <div className="grid grid-cols-6 mx-auto h-16">
        <button onClick={() => router.back()} className="ml-5">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="w-full bg-white rounded-full h-2.5 mt-[27px] col-span-4">
          <div className="bg-[#B5F1F9] h-2.5 rounded-full w-[14%]"></div>
        </div>
        <button
      ...
      <div className="mt-5">
        <button
          ...
          className="w-full"
        >
          <div className="bg-white rounded-lg flex items-center justify-start m-8 mb-0">
            <div className="m-5">
        ...
        >
          <div className="bg-white rounded-lg flex items-center justify-start m-8">
            <div className="ml-4 whitespace-nowrap inline-flex m-5">
              <h1 className="font-bold inline-block">My Child</h1>
              <h1 className="text-gray-500 text-xs inline-block mt-1 ml-2">
                (18 and younger)
              </h1>
            </div>
          </div>
